export const sampleArticle = `LONDON, England (Reuters) -- Harry Potter star Daniel Radcliffe
...
export const sampleLLMSummary = `As Daniel Radcliffe turns 18, he gains access to a £20 million ($41.1 million) fortune but vows to avoid extravagant spending. Known for his role as Harry Potter, Radcliffe plans to keep his lifestyle modest, preferring to buy books, CDs, and DVDs. Despite newfound freedoms like gambling and drinking, he aims to stay grounded and avoid the pitfalls of fame. His earnings from the Harry Potter films have been held in a trust until now. Radcliffe's latest film, "Harry Potter and the Order of the Phoenix," is breaking records, and he will reprise his role in the final two films. Beyond Potter, he stars in "My Boy Jack," "December Boys," and made his stage debut in "Equus." Aware of increased media scrutiny, he remains focused on his career and personal values.`

export const sampleHumanSummary = `As Daniel Radcliffe turns 18, he gains access to a £20 million ($41.1 million) fortune but intends to spend modestly, favoring books, CDs, and DVDs over luxury items. Known for his role as Harry Potter, he rejects the idea of indulging in fast cars or wild parties. Despite new freedoms such as gambling and drinking, Radcliffe remains focused on staying grounded. His earnings from the first five Harry Potter films were held in a trust fund. His latest film, "Harry Potter and the Order of the Phoenix," is highly successful, and he will reprise his role in the final two films. Additionally, Radcliffe has diversified his career with roles in "My Boy Jack," "December Boys," and his stage debut in "Equus." He anticipates increased media scrutiny now that he is legally an adult.`;