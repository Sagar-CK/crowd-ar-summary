...
const PreTask = ({globalState, setGlobalState}: GlobalStateProps) => {
  ...
  return (
    <div className="flex flex-col w-full h-full items-center gap-y-4">
      ...
      <p className="text-wrap max-w-screen-lg align-top text-sm">
        ...
        from which you are tasked to do one of the following:
        </p>
        <ul className="list-decimal list-inside font-semibold text-sm">
          ...
          {/* <li>Evaluate a text summary on its overall quality</li> */}
        </ul>
        <p className="text-wrap max-w-screen-lg align-top text-sm">
      ...
      <div className="flex flex-col items-center gap-4 text-sm">
        ...
        <label className="flex items-center gap-2">
          ...
          <input type="text" className="border p-2 mt-1" onChange={handleProlificIdChange} />
        </label>
        <button
          className="bg-blue-500 text-white py-2 px-4 rounded mt-4 disabled:bg-gray-500"
          onClick={handleProceed}
          disabled={!consent || prolificId.length <= 0}
        >
          Submit
        </button>
      </div>
